...
<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu"
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('order.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->routeIs('order.index') ? 'active' : '' }}"
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('parent-category.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->routeIs('parent-category.index') ? 'active' : '' }}"
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('category.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('attribute.*') || request()->routeIs('attributevalue.*') ? 'here show' : '' }}">
                <!--begin:Menu link-->
                ...
                <div class="menu-sub menu-sub-accordion">
                    <!--begin:Submenu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ request()->routeIs('attribute.index') ? 'active' : '' }}"
                    ...
                    <!--begin:Submenu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ request()->routeIs('attributevalue.index') ? 'active' : '' }}"
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('product.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->routeIs('product.index') ? 'active' : '' }}"
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('delivery.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->routeIs('delivery.index') ? 'active' : '' }}"
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('reel.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->routeIs('reel.index') ? 'active' : '' }}"
                        href="{{ route('reel.index') }}">
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('team.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->routeIs('team.index') ? 'active' : '' }}"
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('blog.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('faq.index') ? 'here show' : '' }}">
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->routeIs('faq.index') ? 'active' : '' }}"
         ...
         <!--end:Menu item-->
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('user.*') || request()->routeIs('roles.*') || request()->routeIs('permissions.*') ? 'here show' : '' }}">
                <!--begin:Menu link-->
                <span class="menu-link">
                    <span class="menu-icon">
                ...
                <div class="menu-sub menu-sub-accordion">
                    <!--begin:Submenu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('user.index') || request()->is('user/*') ? 'active' : '' }}"
                    ...
                    <!--begin:Submenu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('roles.index') || request()->is('roles/*') ? 'active' : '' }}"
                    ...
                    <!--begin:Submenu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ request()->is('permissions.index') || request()->is('permissions/*') ? 'active' : '' }}"
            ...
            <!--begin:Menu item-->
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('preference.*') || request()->routeIs('general.*') ? 'here show' : '' }}">
                <!--begin:Menu link-->
                <span class="menu-link">
                    <span class="menu-icon">
                        <i class="fa fa-cog" aria-hidden="true"></i>
                ...
                <div class="menu-sub menu-sub-accordion">
                    <!--begin:Submenu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ request()->routeIs('general.index') ? 'active' : '' }}"
                    ...
                    <!--begin:Submenu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ request()->routeIs('preference.index') ? 'active' : '' }}"
