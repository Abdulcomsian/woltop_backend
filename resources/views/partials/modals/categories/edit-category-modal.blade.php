                ...
                <form action="{{ route('update.category') }}" id="edit_categoy_form" method="POST"
                    ...
                    <!--end::Input group-->
                      ...
                      <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="intro_heading" id="intro_heading" class="form-control form-control-solid" placeholder="Enter Intro Heading">
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea name="intro_description" id="intro_description" class="form-control form-control-solid" placeholder="Enter Intro Description"></textarea>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    </div>
