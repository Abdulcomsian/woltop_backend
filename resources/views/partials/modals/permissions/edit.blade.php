                ...
                <form action="{{route('parent-category.update')}}" id="edit_parent_categoy_form" method="POST">
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name" id="parent_category_name_edit" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Permission Name"/>
                            <span class="text-danger" id="edit_parent_category_name_err" style="display: none;">Permission name is required</span>
                            <!--end::Input-->
                            @error('name')
